...
namespace DBConnection
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            //fileItem.DropDownItems.Add("Connect to DB");
            //fileItem.DropDownItems.Add(new ToolStripMenuItem("Disconnect from DB"));
            //fileItem.DropDownItems.Add(new ToolStripMenuItem("List connection"));
